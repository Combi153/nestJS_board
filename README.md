...
```bash
npm run typeorm -- migration:generate ./src/database/migration/change-schema -d ./src/database/app-data-source.ts
```

- run migration query

```bash
npm run typeorm -- migration:run -d ./src/database/app-data-source.ts
```

- revert migration query

```bash
npm run typeorm -- migration:revert -d ./src/database/app-data-source.ts
```

- [document](https://orkhan.gitbook.io/typeorm/docs/using-cli)
